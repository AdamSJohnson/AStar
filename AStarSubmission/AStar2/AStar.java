...
public class AStar{
    public static void main(String[] args) throws FileNotFoundException{
        ...
        ASTNode root = new ASTNode(nul, nul, nul, map.get(start), 0.0, 0.0, 0.0, 1);
    ...
    public void run(){
        ...
        while(true){
            ...
            if(current.expanded()){
                ...
                if(lowest == null){
                    lowest = current;
                } else if(current.heuristic() < lowest.heuristic()){
                    lowest = current;
                }
                    ...
                    if(current.parent != null){
                        ...
                        if(current.parent == null){
                            ...
                            if(lowest.city.name.equals(end)){
                                ...
                                System.out.print(lowest.heuristic());
                                System.out.println(" : (Path Length) " + lowest.g2cost);
                                tracePath(lowest);
                                return;
                            }
...
class ASTNode{
    ...
    public ASTNode(ASTNode p, ASTNode r, ASTNode l, Node c, double g, double g2, double g3, int dep){
        this.parent = p;
        this.rightSib = r;
        this.leftSib = l;
        this.city = c;
    ...
    public void expand(Map m){
        ...
        for(int i = 0; i < city.getEdges().length; i++){
            ...
            curr = new ASTNode(this, nul, left,node,this.gcost + city.getEdges()[i].danger, this.g2cost + city.getEdges()[i].distance, this.g3cost + city.getEdges()[i].roadcon, this.depth);
    ...
    public double heuristic(){
        ...
        //so we multiply the distance by the sum of the roadcon divided by the sum of the danger
        //multiplied by a .2 constant to reduce doublebacking
        return city.distance + g3cost / gcost * .2 *  g2cost; 
    }
