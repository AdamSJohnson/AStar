...
//AStarTree keeps track of a few things:
//1: It stores the root node and a copy of the map we made earlier
//2: The run function goes through the entire AStar algorithm to find the best
//   path given our heuristic function.
class AStarTree{
    ASTNode root;
    Map map;
    ...
    //Calling run() with a root node will execute the algorithm for AStar.
    //Run will expand the root out creating a generalized tree. 
    public void run(){
                    ...
                    if(current.parent != null){
                        ...
                        if(current.parent == null){
                            ...
                            if(lowest.city.name.equals(end)){
                                ...
                                System.out.println(lowest.heuristic());
                                tracePath(lowest);
                                return;
                            }
    ...
    //Trace path takes any node and prints the path up to the root.
