...
public class AStar{
    public static void main(String[] args) throws FileNotFoundException{
        ...
        ASTNode root = new ASTNode(nul, nul, nul, map.get(start), 0.0, 0.0, 1);
                    ...
                    if(current.parent != null){
                        ...
                        if(current.parent == null){
                            ...
                            if(lowest.city.name.equals(end)){
                                ...
                                System.out.println(lowest.g2cost);
                                tracePath(lowest);
                                return;
                            }
...
class ASTNode{
    ...
    public ASTNode(ASTNode p, ASTNode r, ASTNode l, Node c, double g, double g2, int dep){
        this.parent = p;
        this.rightSib = r;
        this.leftSib = l;
        this.city = c;
    ...
    public void expand(Map m){
        ...
        for(int i = 0; i < city.getEdges().length; i++){
            ...
            curr = new ASTNode(this, nul, left,node,this.gcost + city.getEdges()[i].roadcon, this.g2cost + city.getEdges()[i].distance, this.depth);
    ...
    public double hueristic(){
        ...
        return city.distance + g2cost - (gcost);
    }
